/**
 * Cursor 汉化翻译字典
 * safeGlobalDict: 安全长句，可全局替换
 * riskyShortWords: 短词，仅在 UI 属性上下文中替换
 */
const { agentSafeAddon, agentRiskyAddon } = require('./dict-agent-addon');
const { settingsSafeAddon, settingsRiskyAddon } = require('./dict-settings-addon');
...
const safeGlobalDict = {
  ...
  'Entry-level plan with access to premium models, unlimited Tab completions, and more.':
    '入门级方案，可使用高级模型、无限 Tab 补全等。',
  'Warning Notifications': '警告通知',
  'Show warning-level in-app toasts': '显示应用内警告级别通知',
  ...
  'Accept and Run': '接受并运行',
  'Accept pending agent pane action': '接受待处理的智能体面板操作',
  'Add to Chat': '添加到聊天',
  'Add to Composer': '添加到 Composer',
  'Agent Mode': '智能体模式',
  'Agent Pane': '智能体面板',
  'Agent Review on Commit': '提交时智能体审查',
  'Ask Mode': '问答模式',
  'Ask mode': '问答模式',
  ...
  'Debug Mode': '调试模式',
  'Delete Chat': '删除聊天',
  'Disable Cursor Tab': '禁用 Cursor Tab 补全',
  'Discard Changes': '放弃更改',
  'Edit in Agent': '在智能体中编辑',
  'Enable Cursor Tab': '启用 Cursor Tab 补全',
  'Export Chat': '导出聊天',
  ...
  'A newer version of Cursor is available. We recommend updating for the best experience.': '有更新版本的 Cursor 可用，建议更新以获得最佳体验。',
  'API key rate limit exceeded.': 'API 密钥速率限制已超出。',
  'AI Features are disabled for this file.': '此文件的 AI 功能已禁用。',
  'Configure keyboard shortcuts': '配置键盘快捷键',
  ...
  'Preferences: Open User Settings': '首选项：打开用户设置',
  'Preferences: Open Workspace Settings': '首选项：打开工作区设置',
  ...
  'Compare with checkpoint': '与检查点比较',
  'Files changed': '文件已更改',
  'Lines added': '新增行',
  'Lines removed': '删除行',
  'No changes': '无更改',
